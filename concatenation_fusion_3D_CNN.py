...
# Function that creates a baseline 3D CNN model using a training dataset and a specified input shape
def create_baseline_3D_CNN_model(x_ds, input_shape):
...
def create_multi_branch_3D_CNN_model():
...
def test_concatenation_based_fusion(steps_per_epoch, validation_steps, subset_dirs, train_ds, val_ds, test_ds):
    ...
    model = create_baseline_3D_CNN_model(train_concatenated_frames, input_shape)
